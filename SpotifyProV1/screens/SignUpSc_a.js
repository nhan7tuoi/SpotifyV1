...
const SignUpSc_a = ({navigation}) => {
    return (
        <LinearGradient style={{ flex: 1 }} colors={["#040306", "#131624"]}>
            <SafeAreaView style={{ flex: 1 }}>
                <View style={{ padding: 20, width: '100%' }}>
                   <Text style={{color:'#fff',fontSize:20,fontWeight:'bold',marginBottom:10}}>What's your email?</Text>
                   <TextInput style={{width:'100%',height:50,backgroundColor:'#474444',marginBottom:10,fontSize:20}}/>
                   <Text style={{color:'#fff',fontSize:12,fontWeight:500}}>You’ll need to confirm this email later.</Text>
                </View>
                <View style={{justifyContent:'center',alignItems:'center',width:'100%'}}>
                    <Pressable onPress={()=>{navigation.navigate('SignUpSc_b')}}
